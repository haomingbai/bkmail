/**
 * @file include/bkmail/imap/command/subscribe_command.h
...
#pragma once
#ifndef BKMAIL_IMAP_COMMAND_SUBSCRIBE_COMMAND_H_
#define BKMAIL_IMAP_COMMAND_SUBSCRIBE_COMMAND_H_
...
class subscribe_command {
 public:
  ...
  explicit subscribe_command(std::string_view mailbox,
  ...
  /// SUBSCRIBE never waits for a continuation request.
  ...
  /// SUBSCRIBE expects no continuation; ignored.
  void on_continuation(std::string_view /*text*/) {}

  /// SUBSCRIBE collects no untagged responses.
  void on_untagged(const untagged_response<Allocator>& /*r*/) {}

  /// Advisory for the write pump: SUBSCRIBE pipelines freely.
...
#endif  // BKMAIL_IMAP_COMMAND_SUBSCRIBE_COMMAND_H_
