/**
 * @file include/bkmail/imap/command/unsubscribe_command.h
...
#pragma once
#ifndef BKMAIL_IMAP_COMMAND_UNSUBSCRIBE_COMMAND_H_
#define BKMAIL_IMAP_COMMAND_UNSUBSCRIBE_COMMAND_H_
...
class unsubscribe_command {
 public:
  ...
  explicit unsubscribe_command(std::string_view mailbox,
  ...
  /// UNSUBSCRIBE never waits for a continuation request.
  ...
  /// UNSUBSCRIBE expects no continuation; ignored.
  void on_continuation(std::string_view /*text*/) {}

  /// UNSUBSCRIBE collects no untagged responses.
  void on_untagged(const untagged_response<Allocator>& /*r*/) {}

  /// Advisory for the write pump: UNSUBSCRIBE pipelines freely.
...
#endif  // BKMAIL_IMAP_COMMAND_UNSUBSCRIBE_COMMAND_H_
